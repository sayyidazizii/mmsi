...
class CoreMember_model extends CI_Model{
	...
	var $column_order = array(null, 'member_no', 'member_name', 'member_address', 'member_status', 'member_reference', 'member_phone', 'member_principal_savings_last_balance', 'member_special_savings_last_balance', 'member_mandatory_savings_last_balance'); //field yang ada di table user
	...
	public function getMemberReference(){
		$hasil = $this->db->query("
...
// 	public function getCoreMemberWorking($member_id){
// 		$this->db->select('member_working_id, member_id');
// 		$this->db->from('core_member_working');
// 		$this->db->where('member_id', $member_id);
// 		return $this->db->get()->row_array();
// 	}
