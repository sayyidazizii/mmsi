<?php
	...
	class CoreOffice_model extends CI_Model {
		...
		public function getDataCoreOffice(){
			$this->db->select('core_office.office_id, core_office.office_code, core_office.office_name,core_office.branch_id, core_branch.branch_name, CONCAT(acct_savings_account.savings_account_no, '.', " - " ,'.' , core_member.member_name) AS savings_account_code');
		...
		public function getAcctSavingsAccount(){
			$this->db->select('acct_savings_account.savings_account_id, CONCAT(acct_savings_account.savings_account_no, '.', " - " ,'.', core_member.member_name) AS savings_account_code');
		...
		public function getCoreOffice_Detail($office_id){
			$this->db->select('core_office.office_id, core_office.office_code, core_office.office_name, core_office.branch_id, core_office.user_id, core_office.savings_account_id');
			$this->db->from('core_office');
