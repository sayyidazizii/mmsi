<?php
	...
	class AcctCreditsAgunan_model extends CI_Model {
		...
		public function getAgunanSKDescription($credits_agunan_type, $credits_account_id){
			$this->db->select('credits_agunan_sk_description');
			...
			$result = $this->db->get()->row_array();
			return $result['credits_agunan_sk_description'];
		}
		
		public function getAgunanManulifeDescription($credits_agunan_type, $credits_account_id){
			$this->db->select('credits_agunan_manulife_description');
			$this->db->from('acct_credits_agunan');
			$this->db->where('credits_agunan_type', $credits_agunan_type);
			$this->db->where('credits_account_id', $credits_account_id);
			$result = $this->db->get()->row_array();
			return $result['credits_agunan_manulife_description'];
		}
		
		public function getAgunanBPJSDescription($credits_agunan_type, $credits_account_id){
			$this->db->select('credits_agunan_bpjs_description');
			$this->db->from('acct_credits_agunan');
			$this->db->where('credits_agunan_type', $credits_agunan_type);
			$this->db->where('credits_account_id', $credits_account_id);
			$result = $this->db->get()->row_array();
			return $result['credits_agunan_bpjs_description'];
		}
