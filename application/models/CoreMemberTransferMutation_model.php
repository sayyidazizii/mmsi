<?php
	...
	class CoreMemberTransferMutation_model extends CI_Model {
		...
		public function getAcctSavingsAccountAmount($savings_account_id){
			$this->db->select('savings_account_blockir_amount, savings_account_blockir_status, savings_account_last_balance');
			$this->db->from('acct_savings_account');
