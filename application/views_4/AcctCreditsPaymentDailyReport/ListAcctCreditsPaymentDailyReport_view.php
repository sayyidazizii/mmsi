...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits-payment-report">
				Daftar Angsuran Pinjaman Harian
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
<h3 class="page-title">
	Daftar Angsuran Pinjaman Harian<small> Kelola Daftar Angsuran Pinjaman Harian</small>
</h3>
<?php
...
?>	
<?php	echo form_open('credits-payment-daily-report/viewreport',array('id' => 'myform', 'class' => '')); 
?>
<div class="row">
	<div class="col-md-12">
