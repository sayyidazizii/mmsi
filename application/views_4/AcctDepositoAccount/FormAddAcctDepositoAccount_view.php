...
<script>
			...
			onChange: function(value) {
				...
				$.post(base_url + 'deposito-account/get-deposite-account-no', {
					...
					function(data) {
						...
						$("#deposito_account_commission").textbox('setValue', obj['deposito_commission']);
						$("#deposito_account_commission_on_hold").textbox('setValue', obj['deposito_commission_on_hold']);
						$("#deposito_account_commission_disbursed").textbox('setValue', obj['deposito_commission_disbursed']);
					},
				)
			}
		})
	...
	$(document).ready(function() {
		$('#deposito_account_commission').textbox({
			onChange: function(value) {
				var nilai_bv = document.getElementById("deposito_account_bv_amount").value;
				var komisi = document.getElementById("deposito_account_commission").value;
				var nilai_komisi = document.getElementById("deposito_account_commission_amount").value;
				var view = document.getElementById("deposito_account_commission_view").value;

				if (nilai_bv == '') {
					var nilai_komisi = 0;
				} else {
					var nilai_komisi = (nilai_bv * komisi) / 100;
				}
				
				$('#deposito_account_commission').textbox('setValue', komisi);
				$('#deposito_account_commission_amount').textbox('setValue', nilai_komisi);
				$('#deposito_account_commission_view').textbox('setValue', toRp(nilai_komisi));
				console.log(komisi);
				console.log(toRp(nilai_komisi));
	...
	$(document).ready(function() {
		$('#deposito_account_commission_on_hold').textbox({
			onChange: function(value) {
				var nilai_komisi = document.getElementById("deposito_account_commission_amount").value;
				var komisi_ditahan = document.getElementById("deposito_account_commission_on_hold").value;
				var nilai_komisi_ditahan = document.getElementById("deposito_account_commission_on_hold_amount").value;
				var view = document.getElementById("deposito_account_commission_on_hold_view").value;

				if (nilai_komisi == '') {
					var nilai_komisi_ditahan = 0;
				} else {
					var nilai_komisi_ditahan = (nilai_komisi * komisi_ditahan) / 100;
				}
				
				$('#deposito_account_commission_on_hold').textbox('setValue', komisi_ditahan);
				$('#deposito_account_commission_on_hold_amount').textbox('setValue', nilai_komisi_ditahan);
				$('#deposito_account_commission_on_hold_view').textbox('setValue', toRp(nilai_komisi_ditahan));
				console.log(komisi_ditahan);
				console.log(toRp(nilai_komisi_ditahan));
	...
	$(document).ready(function() {
		$('#deposito_account_commission_disbursed').textbox({
			onChange: function(value) {
				var nilai_komisi = document.getElementById("deposito_account_commission_amount").value;
				var komisi_dicairkan = document.getElementById("deposito_account_commission_disbursed").value;
				var nilai_komisi_dicairkan = document.getElementById("deposito_account_commission_disbursed_amount").value;
				var view = document.getElementById("deposito_account_commission_disbursed_view").value;

				if (nilai_komisi == '') {
					var nilai_komisi_dicairkan = 0;
				} else {
					var nilai_komisi_dicairkan = (nilai_komisi * komisi_dicairkan) / 100;
				}
				
				$('#deposito_account_commission_disbursed').textbox('setValue', komisi_dicairkan);
				$('#deposito_account_commission_disbursed_amount').textbox('setValue', nilai_komisi_dicairkan);
				$('#deposito_account_commission_disbursed_view').textbox('setValue', toRp(nilai_komisi_dicairkan));
				console.log(komisi_dicairkan);
				console.log(toRp(nilai_komisi_dicairkan));
	...
	$(document).ready(function() {
		$('#deposito_account_amount_view').textbox({
			onChange: function(value) {
				...
				var bv = document.getElementById("deposito_account_bv_percentage").value;
				var nilai_bv = document.getElementById("deposito_account_bv_amount").value;
				var view_bv = document.getElementById("deposito_account_bv_amount_view").value;

				var nilai_produk = document.getElementById("deposito_account_amount").value;
				var cb = document.getElementById("deposito_account_cb_percentage").value;
				var nilai_cb = document.getElementById("deposito_account_cb_amount").value;
				var view_cb = document.getElementById("deposito_account_cb_amount_view").value;

				var komisi = document.getElementById("deposito_account_commission").value;
				var nilai_komisi = document.getElementById("deposito_account_commission_amount").value;
				var view_komisi = document.getElementById("deposito_account_commission_view").value;

				var komisi_ditahan = document.getElementById("deposito_account_commission_on_hold").value;
				var nilai_komisi_ditahan = document.getElementById("deposito_account_commission_on_hold_amount").value;
				var view_komisi_ditahan = document.getElementById("deposito_account_commission_on_hold_view").value;
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="member_no" id="member_no" value="<?php echo $coremember['member_no']; ?>" style="width: 68.5%" readonly autofocus /> <a href="#" role="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#memberlist" style="width: 30%"><i class="fa fa-search"></i> Cari Anggota</a> </td>
									</tr>
									<tr>
							...
							<div class="col-md-6">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="deposito_account_unique_code" id="deposito_account_unique_code" autocomplete="off" style="width:65.8%" value="<?php echo $uniquecode ?>" readonly />
									...
									<tr>
										<td width="35%">Komisi (%)<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="deposito_account_commission" id="deposito_account_commission" autocomplete="off" placeholder="%" value="<?php echo set_value('deposito_account_commission', $data['deposito_account_commission']); ?>" style="width:22.4%"  readonly/>
											<input type="text" class="easyui-textbox" name="deposito_account_commission_view" id="deposito_account_commission_view" placeholder="Nominal" value="<?php echo set_value('deposito_account_commission_view', $data['deposito_account_commission_view']); ?>" style="width:76.5%" readonly />
										</td>
										<input type="hidden" class="easyui-textbox" name="deposito_account_commission_amount" id="deposito_account_commission_amount" autocomplete="off" value="<?php echo set_value('deposito_account_commission_amount', $data['deposito_account_commission_amount']); ?>" />
									<tr>
										<td width="35%">Komisi Ditahan (%)<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="deposito_account_commission_on_hold" id="deposito_account_commission_on_hold" autocomplete="off" placeholder="%" value="<?php echo set_value('deposito_account_commission_on_hold', $data['deposito_account_commission_on_hold']); ?>" style="width:22.4%"  readonly/>
											<input type="text" class="easyui-textbox" name="deposito_account_commission_on_hold_view" id="deposito_account_commission_on_hold_view" placeholder="Nominal" value="<?php echo set_value('deposito_account_commission_on_hold_view', $data['deposito_account_commission_on_hold_view']); ?>" style="width:76.5%" readonly />
										</td>
									</tr>
									<input type="hidden" class="easyui-textbox" name="deposito_account_commission_on_hold_amount" id="deposito_account_commission_on_hold_amount" autocomplete="off" value="<?php echo set_value('deposito_account_commission_on_hold_amount', $data['deposito_account_commission_on_hold_amount']); ?>" readonly/>
									<tr>
										<td width="35%">Komisi Dicairkan(%)<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="deposito_account_commission_disbursed" id="deposito_account_commission_disbursed" autocomplete="off" placeholder="%" value="<?php echo set_value('deposito_account_commission_disbursed', $data['deposito_account_commission_disbursed']); ?>" style="width:22.4%"  readonly/>
											<input type="text" class="easyui-textbox" name="deposito_account_commission_disbursed_view" id="deposito_account_commission_disbursed_view" placeholder="Nominal" value="<?php echo set_value('deposito_account_commission_disbursed_view', $data['deposito_account_commission_disbursed_view']); ?>" style="width:76.5%" readonly />
										</td>
									</tr>
									<input type="hidden" class="easyui-textbox" name="deposito_account_commission_disbursed_amount" id="deposito_account_commission_disbursed_amount" autocomplete="off" value="<?php echo set_value('deposito_account_commission_disbursed_amount', $data['deposito_account_commission_disbursed_amount']); ?>" readonly/>
									<tr>
