...
if (empty($data['deposito_bv_percentage'])) {
	$data['deposito_bv_percentage'] = '';
}

if (empty($data['deposito_cb_percentage'])) {
	$data['deposito_cb_percentage'] = '';
}

if (empty($data['deposito_commission_on_hold'])) {
	$data['deposito_commission_on_hold'] = '';
}

if (empty($data['deposito_commission_disbursed'])) {
	$data['deposito_commission_disbursed'] = '';
}
