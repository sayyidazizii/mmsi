...
<script>
	...
	$(document).ready(function() {
		...
		$('#branch_id').combobox({
			onChange: function(value) {
				function_elements_add('branch_id', value);
			}
		});

		$('#member_reference').combobox({
			onChange: function(value) {
				function_elements_add('member_reference', value);
			}
		});
						...
						<div class="row">
							...
							<div class="col-md-6">
								<table style="width:100%">
									...
									<tr>
										<td width="35%">Kantor Cabang<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
											echo form_dropdown('branch_id', $corebranch, set_value('branch_id', $data['branch_id']), 'id="branch_id" class="easyui-combobox" style="width:100%;"');
											?>
										</td>
									</tr>
									<tr>
									...
									<input type="hidden" class="easyui-textbox" name="member_token" id="member_token" autocomplete="off" value="<?php echo set_value('member_token', $member_token); ?>" />
									<tr>
									...
									<input type="hidden" class="easyui-textbox" name="member_principal_savings" id="member_principal_savings" value="<?php echo set_value('member_principal_savings', $preferencecompany['member_mandatory_savings']); ?>" />
									<!-- <tr>
										<td width="35%"></td>
										<td width="5%"></td>
									</tr> -->
									...
									<tr>
										<td width="35%">Anggota Aktif<span class="required" style="color : blue">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
