...
<?php defined('BASEPATH') OR exit('No direct script access allowed');
	...
	Class AcctGeneralLedgerReport extends CI_Controller{
		...
		public function index(){
			...
			// print_r($sesi['month_period_start']);exit;
			...
			$opening_balance_amount = $this->AcctGeneralLedgerReport_model->getOpeningBalance($sesi['account_id'],$sesi['month_period_start'], $sesi['year_period'], $sesi['branch_id']);
