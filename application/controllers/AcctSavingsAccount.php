	...
	Class AcctSavingsAccount extends CI_Controller{
		...
		public function getAcctSavingsAccountList(){
	        ...
	        foreach ($list as $savingsaccount) {
	            ...
	            $row[] = number_format($savingsaccount->savings_account_blockir_amount, 2);
		...
		public function addAcctSavingsAccount(){
			...
			$data['main_view']['coremethod']			= $coremethod;
		...
		public function processAddAcctSavingsAccount(){
			...
			$savings_point 				= $this->AcctSavingsAccount_model->getAcctSavingsPoint($data['savings_id']);
					...
					if($this->AcctSavingsAccount_model->insertAcctSavingsAccount($data)){
						...
						if($data['savings_account_first_deposit_amount'] > 0){
							if($data['method_id'] == 0){
								...
								$account_id_default_status 			= $this->AcctSavingsAccount_model->getAccountIDDefaultStatus($account_bank_id);
								...
								$data_debet = array (
									...
									'account_id_default_status'		=> $account_id_default_status,
									'account_id_status'				=> 0,
									'journal_voucher_item_token'	=> $data['savings_account_token'].$account_bank_id,
									'created_id' 					=> $auth['user_id'],
								);
							}
						...
						$data_point = array(
							...
							'point_from' 	=> 'Buka Tabungan',
							'point_amount' 	=> $savings_point,
							'branch_id' 	=> $auth['branch_id'],
							'created_id' 	=> $auth['user_id'],
		...
		public function printNoteAcctSavingsAccount(){
			...
			<table cellspacing=\"0\" cellpadding=\"1\" border=\"0\">
			    <tr>
			        ...
			        <td width=\"40%\"><div style=\"text-align: left; font-size:14px\"><br>BUKTI SETORAN AWAL TABUNGAN</div></td>
			    </tr>
			    <tr>
