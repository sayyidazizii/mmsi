<?php
	...
	Class CoreMemberTransferMutation extends CI_Controller{
		...
		public function processAddCoreMemberTransferMutation(){
			...
			$savingsaccount 					= $this->CoreMemberTransferMutation_model->getAcctSavingsAccountAmount($data['savings_account_id']);
			...
			$systempointsetting 				= $this->CoreMemberTransferMutation_model->getSystemPointSetting();
			...
			if($this->form_validation->run()==true){
				if($savingsaccount['savings_account_last_balance'] - $data['member_mandatory_savings'] >= $savingsaccount['savings_account_blockir_amount']){
		...
		public function printCoreMemberTransferMutation(){
			...
			<table cellspacing=\"0\" cellpadding=\"1\" border=\"0\">
			    <tr>
			        ...
			        <td width=\"40%\"><div style=\"text-align: left; font-size:14px\"><br>BUKTI TRANSFER SIMPANAN WAJIB</div></td>
			    </tr>
			    <tr>
