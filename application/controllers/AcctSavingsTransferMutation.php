<?php
	...
	Class AcctSavingsTransferMutation extends CI_Controller{
		...
		public function processAddAcctSavingsTransferMutation(){
			...
			$savingsaccount	= $this->AcctSavingsTransferMutation_model->getAcctSavingsAccount_Detail($this->input->post('savings_account_from_id', true));

			if($this->form_validation->run()==true){
				if(($savingsaccount['savings_account_last_balance'] - $data['savings_transfer_mutation_amount']) >= $savingsaccount['savings_account_blockir_amount']){
