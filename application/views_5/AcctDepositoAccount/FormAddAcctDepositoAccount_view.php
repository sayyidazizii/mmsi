						...
						<div class="row">
							...
							<div class="col-md-6">
								<table width="100%">
									...
									<tr>
										<td width="35%">Agent<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="member_agent" id="member_agent" placeholder="Nominal" value="<?php echo set_value('member_agent', $memberagent['savings_account_no']); ?>" style="width:99.8%" />
										</td>
									</tr>
									...
									<tr>
										<td width="35%">Supervisor<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
