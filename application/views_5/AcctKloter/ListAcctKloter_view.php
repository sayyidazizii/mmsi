                    ...
                    <table class="table table-striped table-bordered table-hover table-full-width" id="sample_3">
                        <thead>
                            <tr>
                                ...
                                <th width="7%">Kuota Kloter</th>
                                <th width="10%">Jangka Waktu (Bulan)</th>
                                <th width="10%">Nominal Partisipan (Rp)</th>
                                <th width="10%">Total Hadiah (Rp)</th>
                                <th width="10%">Hadiah</th>
                                <th width="10%">COA Pendapatan Partisipasi</th>
                                    ...
                                    echo "
										<tr>			
											...
											<td>
												...
												<a href='" . $this->config->item('base_url') . 'kloter/member-participate/' . $val['kloter_id'] . "' class='btn default btn-xs purple'><i class='fa fa-users'></i> Partisipan</a>
