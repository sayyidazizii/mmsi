						...
						<div class="col-md-12">
							<table style="width: 100%;" border="0" padding="0">
								...
								<tr>
									...
									<td width="5%"> : </td>
									<td width="60%">
										<input class="easyui-textbox" type="text" name="debt_repayment_date" readonly id="debt_repayment_date" value="<?php echo $debtrepaymentdetail['debt_repayment_date']; ?>" style="width: 100%"/>
							...
							<table class="table table-bordered table-advance table-hover" width="100%">
								<tbody>
									<tr>    
										...
										<th width='25%' style='text-align:center;'>Jumlah Pelunasan Piutang Potong Gaji</th>	
									</tr>
									<?php
										$no = 1;
