...
$route['deposito-account/reject']                                   = 'AcctDepositoAccount/rejectAcctDepositoAccount';
...
$route['deposito-account/print-bilyet/(:num)']                      = 'AcctDepositoAccount/printCertificateAcctDepositoAccountBilyet/$1';
$route['deposito-account/print-certificate-deposito']               = 'AcctDepositoAccount/printCertificateDeposito';
$route['deposito-account/delete/(:num)']                            = 'AcctDepositoAccount/deleteAcctDeposito/$1';
$route['deposito-account/generate-unique-code']                     = 'AcctDepositoAccount/generateUniqueCode';
$route['deposito-account/commission/(:num)']                        = 'AcctDepositoAccount/listAcctCommission/$1';
...
$route['salary-payments/ind-cash-less-payment']                   = 'AcctSalaryPayments/indCashLessPayment';
...
$route['salary-payments/add-cash-less-payment']                   = 'AcctSalaryPayments/addCashlessPayment';
$route['salary-payments/add-cash-less-payment/(:num)']            = 'AcctSalaryPayments/addCashlessPayment/$1';
$route['salary-payments/add-cash-less-payment/(:num)/(:num)']     = 'AcctSalaryPayments/addCashlessPayment/$1/$1';
$route['salary-payments/add/(:num)']                              = 'AcctSalaryPayments/addAcctSalaryPayment/$1';
...
$route['salary-payments/print-note-cash-less/(:num)']             = 'AcctSalaryPayments/printNoteCashLessPayment/$1';
...
$route['deposito/set-interest/(:num)']                 = 'AcctDeposito/setInterestAcctDeposito/$1';
$route['deposito/process-set-interest']                 = 'AcctDeposito/processSetInterestAcctDeposito';
...
//System Point 
$route['system-point']                                      = 'SystemPoint';
$route['system-point/filter']                               = 'SystemPoint/filter';
$route['system-point/reset-search']                         = 'SystemPoint/reset_search';
$route['system-point/detail/(:num)']                        = 'SystemPoint/detailSystemPoint/$1';
$route['system-point/setting']                              = 'SystemPoint/settingSystemPoint';
$route['system-point/process-setting']                      = 'SystemPoint/processSettingSystemPoint';
...
//AcctDepositoAccountBufferReport  
$route['deposito-account-buffer-report']                         = 'AcctDepositoAccountBufferReport';
$route['deposito-account-buffer-report/viewreport']              = 'AcctDepositoAccountBufferReport/viewreport';
...
//AcctKloter
$route['kloter']                                                   = 'AcctKloter';
$route['kloter/add']                                               = 'AcctKloter/addAcctKloter';
$route['kloter/member-participate/(:num)']                         = 'AcctKloter/listMemberParticipate/$1';
$route['kloter/process-add-member-participate/(:num)/(:num)']      = 'AcctKloter/processAddMemberParticipate/$1/$1';
$route['kloter/member-participate']                                = 'AcctKloter/listMemberParticipate';
$route['kloter/elements-add']                                      = 'AcctKloter/function_elements_add';
$route['kloter/elements-edit']                                     = 'AcctKloter/function_elements_edit';
$route['kloter/state-add']                                         = 'AcctKloter/function_state_add';
$route['kloter/reset-data']                                        = 'AcctKloter/reset_data';
$route['kloter/process-add']                                       = 'AcctKloter/processAddAcctKloter';
$route['kloter/process-edit']                                      = 'AcctKloter/processEditAcctKloter';
$route['kloter/edit/(:num)']                                       = 'AcctKloter/editAcctKloter/$1';
$route['kloter/detail/(:num)']                                     = 'AcctKloter/detailAcctKloter/$1';
$route['kloter/closing/(:num)']                                    = 'AcctKloter/closingAcctKloter/$1';
$route['kloter/delete/(:num)']                                     = 'AcctKloter/deleteAcctKloter/$1';
