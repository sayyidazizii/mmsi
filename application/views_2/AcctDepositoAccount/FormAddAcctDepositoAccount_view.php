							...
							<div class="col-md-6">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="deposito_account_bv_percentage" id="deposito_account_bv_percentage" autocomplete="off" placeholder="%" value="<?php echo set_value('deposito_account_bv_percentage', $data['deposito_account_bv_percentage']); ?>" style="width:22.4%" />
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input type="text" class="easyui-textbox" name="deposito_account_cb_percentage" id="deposito_account_cb_percentage" autocomplete="off" placeholder="%" value="<?php echo set_value('deposito_account_cb_percentage', $data['deposito_account_cb_percentage']); ?>" style="width:22.4%" />
									...
									<input type="hidden" class="easyui-textbox" name="deposito_account_cb_amount" id="deposito_account_cb_amount" autocomplete="off" value="<?php echo set_value('deposito_account_cb_amount', $data['deposito_account_cb_amount']); ?>" />
									<tr>
										<td width="35%"></td>
										<td width="5%"></td>
