						...
						<div class="row">
							<div class="col-md-6">
								<table style="width:100%">
									...
									<tr>
										<td width="35%">Kantor Cabang<span class="required" style="color : red" style="color : red">*</span></td>
										<td width="5%"></td>
										<td width="60%"><?php echo form_dropdown('branch_id', $corebranch, set_value('branch_id', $coremember['branch_id']), 'id="branch_id" class="easyui-combobox" style="width: 100%" readonly'); ?></td>
									</tr>
									<tr>
									...
									<tr>
										<td width="35%">Nama Panggilan <span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Status Pernikahan<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
									...
									<tr>
										<td width="35%">Nomor Hp<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Status Rumah<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
									...
									<tr>
										<td width="35%">Lama Menetap<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<!-- <tr>
										<td width="35%">Kendaraan yang Dimiliki<span class="required"style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
									...
									<tr>
										<td width="35%">Pendidikan Terakhir<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
									...
									<!-- <tr>
										<td width="35%">Pengguna Unit<span class="required"style="color : red">*</span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
									...
									<tr>
										<td width="35%">Nama Pengampu<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Email<span class="required" style="color : red">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td colspan="3" align="left"><b>Member Referensi</b></td>
									</tr>
									<tr>
										<td width="35%">Anggota Aktif<span class="required" style="color : red" style="color : red">*</span></td>
										<td width="5%"></td>
										<td width="60%"><?php echo form_dropdown('member_reference', $corememberref, set_value('member_no', $coremember['member_reference']), 'id="member_reference" class="easyui-combobox" style="width: 100%"'); ?></td>
									</tr>
								</table>
							</div>
							<div class="col-md-6">
								<table style="width:100%">
									...
									<tr>
										<td width="35%">Divisi<span class=""></span></td>
										<td width="5%">:</td>
										<td width="60%">
											<?php
							...
							<div class="col-md-12">
								<div class="form-action right">
									<table width="100%">
										...
										<tr>
											<td width="35%">Simpanan Khusus<span class="required"style="color : red">*</span></td>
											<td width="5%"></td>
											<td width="60%">
