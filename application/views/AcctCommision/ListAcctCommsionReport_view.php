...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>commision-report">
				Daftar Komisi Cair
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption">
					Daftar Komisi Cair Simpanan Berjangka
				</div>
			</div>
			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<?php	echo form_open('commision-report/viewreport',array('id' => 'myform', 'class' => ''));  

						$auth = $this->session->userdata('auth');

						if(empty($data['deposito_account_id'])){
							$data['deposito_account_id'] = '';
						}
					...
					<div class="row">						
						...
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label">No.Simpanan Berjangka</label>
								<?php echo form_dropdown('deposito_account_id', $coredeposito, set_value('deposito_account_id',$data['deposito_account_id']),'id="deposito_account_id" class="form-control select2me" style="width:70%"');?>
							</div>
						</div>
