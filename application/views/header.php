...
<head>
	<meta charset="utf-8" />
	<link rel="icon" href="<?php echo base_url(); ?>assets/pages/img/logo/logo_kopkar.png" type="image" sizes="16x16" />
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							...
							<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
								...
								<img alt="" class="img-circle" src="<?php echo base_url(); ?>assets/layouts/layout/img/logo/user.png" />
