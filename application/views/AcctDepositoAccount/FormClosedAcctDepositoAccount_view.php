						...
						<div class="row">
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										<td width="35%">Total Bunga diproses (Rp)</td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Total Pajak diproses (Rp)</td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Sisa Bunga (Rp)</td>
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="interest_tamountview" id="interest_amount_view" autocomplete="off" style="width: 100%" value="<?php echo nominal($interest_amount) ?>" readonly/>
										<input type="hidden" class="easyui-textbox" name="interest_amount" id="interest_amount" autocomplete="off" value="<?php echo $interest_amount ?>"/></td>
										
									</tr>
									<tr>
										<td width="35%">Sisa Pajak (Rp)</td>
										<td width="5%">:</td>
