							...
							<div class="col-md-12">
								<table width="100%">
									...
									<tr>
										...
										<td width="20%">
											<?php echo form_dropdown('savings_account_id', $acctsavingsaccount, set_value('savings_account_id',$coreoffice['savings_account_id']),'id="savings_account_id" class="easyui-combobox" style="width:100%"');?>
										</td>
