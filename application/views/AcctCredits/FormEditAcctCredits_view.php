				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="credits_point" id="credits_point" autocomplete="off" value="<?php echo set_value('credits_point',$acctcredits['credits_point']);?>" onChange="function_elements_add(this.name, this.value);"/>
