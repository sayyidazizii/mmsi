<script>
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('credits/elements-add');?>",
	...
	function function_state_add(value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('credits/state-add');?>",
				data : {'value' : value},
				success: function(msg){
			}
		});
	...
	function reset_data(){
		document.location = "<?php echo base_url();?>credits/reset-data";
	}
...
<?php echo form_open('credits/process-add',array('id' => 'myform', 'class' => 'horizontal-form')); ?>
<?php
...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>credits/add">
				Tambah Kode Pinjaman 
			</a>
		</li>
	</ul>
</div>
				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="credits_fine" id="credits_fine" autocomplete="off" value="<?php echo set_value('credits_fine',$data['credits_fine']);?>" onChange="function_elements_add(this.name, this.value);"/>
							...
							<div class="col-md-3">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="credits_point" id="credits_point" autocomplete="off" value="<?php echo set_value('credits_point',$data['credits_point']);?>" onChange="function_elements_add(this.name, this.value);"/>
