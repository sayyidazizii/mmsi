...
<script>
	...
	function calculateSavings(){
		...
		console.log(savings_bank_mutation_opening_balance);
		console.log(savings_bank_mutation_amount);*/
		...
		console.log(savings_bank_mutation_last_balance);
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" style="width: 70%" name="savings_bank_mutation_date" id="savings_bank_mutation_date" autocomplete="off" value="<?php echo date('d-m-Y'); ?>" readonly/>
										</td>
									</tr>
									<tr>
