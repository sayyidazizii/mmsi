...
<script>
	...
	function changeMethod(value){
		if(value == 0){
			document.getElementById("bank_container").style.visibility = "hidden";
		}else{
			document.getElementById("bank_container").style.visibility = "visible";
		}
	}
	 ...
	 $(document).ready(function(){
		 $('#savings_id').combobox({
			onChange: function(value){
				...
				$.post(
					base_url + 'savings-account/get-savings-account-no',{savings_id: savings_id},function(data){
						console.log(data);	
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-textbox" name="member_name" id="member_name" value="<?php echo $coremember['member_no'];?>" style="width: 72%" readonly autofocus/> <a href="#" role="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#memberlist">Cari Anggota</a> </td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-datebox date-picker" name="member_date_of_birth" id="member_date_of_birth" value="<?php echo $coremember['member_date_of_birth'];?>" style="width: 100%" readonly/></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%"><?php echo form_textarea(array('style'=>'width: 100%','rows'=>'2','name'=>'member_address','class'=>'easyui-textarea','id'=>'member_address','disabled'=>'disabled','value'=>$coremember['member_address'])) ?> </td>
									</tr>
									<tr>
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										<td width="35%">Alamat</td>
										<td width="5%">:</td>
										<td width="60%"><?php echo form_textarea(array('style'=>'width: 100%', 'rows'=>'2','name'=>'savings_member_heir_address','class'=>'easyui-textarea','id'=>'savings_member_heir_address','value'=>$data['savings_member_heir_address']))?></td>
									</tr>
									<tr>
										<td width="35%">Hub. Keluarga</td>
										<td width="5%">:</td>
										<td width="60%"><?php echo form_dropdown('savings_member_heir_relationship', $familyrelationship, set_value('savings_member_heir_relationship',$data['savings_member_heir_relationship']),'id="savings_member_heir_relationship" class="easyui-combobox" style="width:100%" ');?></td>
									</tr>
									<tr>
										<td width="35%">Jenis Tabungan<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%"><?php echo form_dropdown('savings_id', $acctsavings, set_value('savings_id',$data['savings_id']),'id="savings_id" class="easyui-combobox" style="width: 100%"');?></td>
									</tr>
									<tr>
										<td width="35%">Tanggal Buka<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%"><input type="text" class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" id="savings_account_date" value="<?php echo date('d-m-Y'); ?>" readonly style="width: 100%" readonly/></td>
									</tr>
									<tr>
										<td width="35%">Bunga (%) Per Bulan<span class="required">*</span></td>
										<td width="5%">:</td>
									...
									<tr>
										<td width="35%">Metode<span class="required">*</span></td>
										<td width="5%">:</td>
										<td width="60%"><?php echo form_dropdown('method_id', $coremethod, set_value('method_id',$data['method_id']),'id="method_id" class="easyui-combobox" style="width:100%" ');?></td>
									</tr>
									<tr id="bank_container" style="visibility:hidden">
										<td width="35%">Bank<span class="required">*</span></td>
										<td width="5%">:</td>
