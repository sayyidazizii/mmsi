				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="savings_point" id="savings_point" autocomplete="off" value="<?php echo set_value('savings_point',$acctsavings['savings_point']);?>" />
