...
<script>
	...
	function function_elements_add(name, value){
		$.ajax({
				type: "POST",
				url : "<?php echo site_url('journal-voucher/elements-add');?>",
							...
							<div class="col-md-5">
								<table width="100%">
									<tr>
										...
										<td width="5%">:</td>
										<td width="60%">
											<input class="easyui-datebox" data-options="formatter:myformatter,parser:myparser" type="text" name="journal_voucher_date" id="journal_voucher_date" onChange="function_elements_add(this.name, this.value);" value="<?php echo tgltoview($data['journal_voucher_date']);?>" style="width: 60%" readonly/>
