...
<script type="text/javascript">
	...
	function reset_search(){
		document.location = base_url +"cash-payments/reset";
	}
</script>
<div class="row-fluid">
...
<div class="page-bar">	
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo base_url();?>cash-payments/ind-cash-payment">
				Daftar Angsuran Tunai
			</a>
			<i class="fa fa-angle-right"></i>
		</li>
	</ul>
...
?>	
<?php	echo form_open('cash-payments/filter-cash-payment',array('id' => 'myform', 'class' => '')); 
	...
	<div class="col-md-12">
		<div class="portlet box blue">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo base_url();?>cash-payments/add" class="btn btn-default btn-sm">
						<i class="fa fa-plus"></i>
						<span class="hidden-480">
							Tambah Angsuran Tunai Baru
						</span>
					</a>
				</div>
			</div>
			...
			<div class="portlet-body">
				<div class="form-body">
					...
					<thead>
						<tr>
							<th width="5%">No</th>
							<th width="12%">Nomor Perjanjian Kredit</th>
...
$(document).ready(function() {
    ...
    table = $('#myDataTable').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('cash-payments/get')?>",
            "type": "POST"
        },
        "columnDefs": [
        { 
