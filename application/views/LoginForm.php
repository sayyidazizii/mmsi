...
<head>
    <meta charset="utf-8" />
    <title>KOPERASI MAJU MAKMUR SEJAHTERA INDONESIA</title>
        ...
        <div class="row bs-reset">
            ...
            <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
                <div class="login-content">
                    ...
                    <img src="<?php echo base_url(); ?>assets/pages/img/logo/logo_kopkar.png" height="50%" width="50%" />
                    <p>KOPERASI MAJU MAKMUR SEJAHTERA INDONESIA</p>
                    <?php
                    echo '' . $this->session->userdata('message');
                    $this->session->unset_userdata('message');
                    ?>
                    <form action="<?php echo base_url(); ?>ValidationProcess/loginValidate" class="login-form" style="" method="post">
                        <div class="alert alert-danger display-hide">
                            <button class="close" data-close="alert"></button>
                            <span>Masukan Username dan Password dengan Benar! </span>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
                            ...
                            <div class="col-xs-6">
                                <input class="form-control form-control-solid placeholder-no-fix form-group" type="password" autocomplete="off" placeholder="Sandi" name="password" required />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                ...
                                <button class="btn grey-mint" type="submit">Masuk</button>
                            </div>
                        </div>
                    </form>
