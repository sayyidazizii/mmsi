				...
				<div class="portlet-body">
					<div class="form-body">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group form-md-line-input">
									<input type="text" class="form-control" name="deposito_cb_percentage" id="deposito_cb_percentage" autocomplete="off" value="<?php echo set_value('deposito_cb_percentage', $acctdeposito['deposito_cb_percentage']); ?>" />
