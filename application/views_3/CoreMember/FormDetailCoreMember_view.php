						...
						<div class="row">
							...
							<div class="col-md-5">
								<table width="100%">
									...
									<tr>
										<td width="35%">Member Referensi</td>
										<td width="5%"></td>
										<td width="60%"><?php echo form_dropdown('member_reference', $corememberref, set_value('member_no', $coremember['member_reference']), 'id="member_reference" class="easyui-combobox" style="width: 100%" readonly'); ?>
										</td>
									</tr>
									<tr>
									...
									<td width="48%">
										<table class="table table-striped table-bordered table-hover table-full-width">
											<thead>
												<tr>
													<th colspan="3">
														<center style="font-weight: bold;">Daftar Simpanan <?php echo $coremember['member_name']; ?></center>
													</th>
												</tr>
												<tr>
													<th width="3%">
									...
									<td width="48%">
										<table class="table table-striped table-bordered table-hover table-full-width">
											<thead>
												<tr>
													<th colspan="3">
														<center style="font-weight: bold;">Daftar Pembiayaan <?php echo $coremember['member_name']; ?></center>
													</th>
												</tr>
												<tr>
													<th width="3%">
													...
													<th width="7%">
														<center>No. Akad</center>
													</th>
													<th width="12%">
														<center>Jenis Pembiayaan</center>
													</th>
												</tr>
											</thead>
											<tbody>
